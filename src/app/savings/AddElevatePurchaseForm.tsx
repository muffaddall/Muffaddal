...
import { createElevatePurchase } from "./actions";

export default function AddElevatePurchaseForm() {
  ...
  const [state, formAction, pending] = useActionState(async (
    ...
    const result = await createElevatePurchase(prev, formData);
    if (!result) {
  ...
  return (
    ...
    >
      ...
      >
        {pending ? "Adding…" : planned ? "Add planned purchase" : "Add Elevate Padel expense"}
      </button>
